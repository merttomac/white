...
RegisterNetEvent('consumables:client:Eat2', function(itemName)
    TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items[itemName], "remove")
    animasyonVeProp(adYemek, animYemek, bodyYemek, 'prop_cs_burger_01', 18905, 0.13, 0.05, 0.02, -50.0, 16.0, 60.0, 35000, true) 
    TriggerEvent('animations:client:EmoteCommandStart', {"eat"})
        TriggerEvent('animations:client:EmoteCommandStart', {"c"})
        Citizen.Wait(35000)
        TriggerServerEvent("QBCore:Server:SetMetaData", "hunger", QBCore.Functions.GetPlayerData().metadata["hunger"] + ConsumeablesEat[itemName])
...
RegisterCommand('hudbitir', function()
    TriggerServerEvent("QBCore:Server:SetMetaData", "hunger", QBCore.Functions.GetPlayerData().metadata["hunger"] - 30)
    TriggerServerEvent("QBCore:Server:SetMetaData", "thirst", QBCore.Functions.GetPlayerData().metadata["thirst"] - 35)
end)

RegisterCommand('hudfulle', function()
    TriggerServerEvent("QBCore:Server:SetMetaData", "hunger", QBCore.Functions.GetPlayerData().metadata["hunger"] + 10)
    TriggerServerEvent("QBCore:Server:SetMetaData", "thirst", QBCore.Functions.GetPlayerData().metadata["thirst"] + 0)
end)
